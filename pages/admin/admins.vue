<template>
  <div>
    <AdminAdd :open="isOpenUserAddForm" @changeUserAddForm="isOpenUserAddForm = false" @refreshUsers="refreshUsers"/>
    <AdminEdit :user-id="selectedUserId" v-if="isOpenEditForm" :open="isOpenEditForm" @changeUserEditForm="isOpenEditForm=false" @refreshUsers="refreshUsers"/>
    <AdminPasswordEdit :user-id="selectedUserId" v-if="isOpenPasswordForm" :open="isOpenPasswordForm" @changeUserPasswordEditForm="isOpenPasswordForm=false" @refreshUsers="refreshUsers"/>
