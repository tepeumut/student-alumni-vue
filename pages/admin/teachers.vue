<template>
  <div>
    <TeacherAdd :open="isOpenUserAddForm" @changeUserAddForm="isOpenUserAddForm = false" @refreshUsers="refreshUsers"/>
    <TeacherEdit :user-id="selectedUserId" v-if="isOpenEditForm" :open="isOpenEditForm" @changeUserEditForm="isOpenEditForm=false" @refreshUsers="refreshUsers"/>
    <TeacherPasswordEdit :user-id="selectedUserId" v-if="isOpenPasswordForm" :open="isOpenPasswordForm" @changeUserPasswordEditForm="isOpenPasswordForm=false" @refreshUsers="refreshUsers"/>
