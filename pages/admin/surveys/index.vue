<template>
  <div>
    <SurveyAdd :open="isOpenSurveyAddForm" @changeSurveyAddForm="isOpenSurveyAddForm = false" @refreshSurveys="refreshSurveys"/>
    <SurveyEdit :survey-id="selectedSurveyId" v-if="isOpenEditForm" :open="isOpenEditForm" @changeSurveyEditForm="isOpenEditForm=false" @refreshSurveys="refreshSurveys"/>
        ...
        <div class="-my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
          <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
            <div class="shadow overflow-hidden border-b border-gray-200 sm:rounded-lg">
              <button type="button"
                      @click="isOpenSurveyAddForm = true"
