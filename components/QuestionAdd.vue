                      ...
                      <div class="md:grid md:grid-cols-3 md:gap-6">
                        <div class="md:col-span-1">
                          <div class="px-4 sm:px-0">
                            <h3 class="text-lg font-medium leading-6 text-gray-900">Anket Soru Ekleyin</h3>
                          </div>
                        </div>
...
export default {
  ...
  methods: {
    changeQuestionAddForm() {
      this.$emit('changeQuestionAddForm');
    },
    addQuestionData() {
    ...
    handleAddForm() {
      ...
      this.$axios.post("/surveys/questions", this.survey).then(res => {
