                      ...
                      <div class="md:grid md:grid-cols-3 md:gap-6">
                        <div class="md:col-span-1">
                          <div class="px-4 sm:px-0">
                            <h3 class="text-lg font-medium leading-6 text-gray-900">Anket Ekleyin</h3>
                          </div>
                        </div>
...
export default {
  ...
  methods: {
    changeSurveyAddForm() {
      this.$emit('changeSurveyAddForm');
    },
    handleAddForm() {
      this.formErrors = [];
      this.loginLoading = true;
      this.$axios.post("/surveys", this.survey).then(res => {
        this.loginLoading = false;
        this.changeSurveyAddForm();
