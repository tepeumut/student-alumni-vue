                      ...
                      <div class="md:grid md:grid-cols-3 md:gap-6">
                        <div class="md:col-span-1">
                          <div class="px-4 sm:px-0">
                            <h3 class="text-lg font-medium leading-6 text-gray-900">İş İlanı Düzenle</h3>
                          </div>
                        </div>
...
export default {
  ...
  methods: {
    ...
    handleEditForm() {
      ...
      this.$axios.put("/jobs/" + this.jobId, this.job).then(res => {
  ...
  created() {
    ...
    this.$axios.get("/jobs/" + this.jobId).then(res => {
      this.job = res.data;
