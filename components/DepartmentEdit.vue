                            ...
                            <div class="px-4 py-5 bg-white sm:p-6">
                              ...
                              <div class="grid grid-cols-6 gap-6 mb-5">
                                <div class="col-span-6">
                                  ...
                                  <input type="text" name="name" id="name" v-model="department.name"
...
export default {
  ...
  methods: {
    changeUserAddForm() {
      this.$emit('changeDepartmentEditForm');
    },
    handleAddForm() {
      this.formErrors = [];
      this.loginLoading = true;
      this.$axios.put(`/faculty-departments/${this.$route.params.id}/departments/${this.departmentId}`, this.department).then(res => {
  ...
  created() {
    this.$axios.get(`/faculty-departments/${this.$route.params.id}/departments/${this.departmentId}`).then(res => {
